    ...
    <div className="min-h-screen flex bg-[#FAF9F6]">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12">
        ...
        >
          ...
          {/* Elegant Role Toggle */}
          <div className="bg-stone-200/60 p-1 rounded-lg flex mb-6 relative">
            <button
              type="button"
              onClick={() => setFormData({ ...formData, role: "buyer" })}
              className={`flex-1 py-2.5 text-sm font-medium rounded-md transition-all duration-300 z-10 ${
                formData.role === "buyer"
          ...
          >
            Create {formData.role === "buyer" ? "Shopper" : "Artisan"} Account
          </button>
